...
#line 121 "parser.y" /* yacc.c:1646  */
    { (yyval.body) = (yyvsp[-2].body);
																			ast_addNode((yyvsp[-2].body), ast_new_strNode(IDENTIFIER, (yyvsp[0].identifier)));
																		}
...
#line 124 "parser.y" /* yacc.c:1646  */
    { (yyval.body) = ast_new_strNode(IDENTIFIER, (yyvsp[0].identifier)); }
...
#line 130 "parser.y" /* yacc.c:1646  */
    {
																			(yyval.body) = ast_new_bodyNodeN(ARRAY_TYPE, 3, ast_new_iNode(INT_CONST, (yyvsp[-6].iValue)), ast_new_iNode(INT_CONST, (yyvsp[-3].iValue)), (yyvsp[0].body));
					 													}
...
#line 166 "parser.y" /* yacc.c:1646  */
    { (yyval.body) = ast_new_bodyNodeN(ASSIGN, 2, 
																						ast_new_strNode(IDENTIFIER, (yyvsp[-2].identifier)), (yyvsp[0].body));
																				}
...
#line 250 "parser.y" /* yacc.c:1646  */
    { (yyval.body) = ast_new_iNode(BOOL_CONST, (yyvsp[0].iValue));}
